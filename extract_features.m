function [features, output] = extract_features(filename)

% Load Contents from  data file into function workspace 
load(filename)


firstIdx = 60000;    % ignore first minute of data 
...
feature_matrix = [LFz_max, RFz_max, LFz_ttp, RFz_ttp, L_stride_length, R_stride_length, L_max_dorsi,...
                                 R_max_dorsi, L_max_plantar, R_max_plantar, ones(num_steps, 1)]
